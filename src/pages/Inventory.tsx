...
export default function Inventory() {
  ...
  const [reportType, setReportType] = useState('Repair'); // Added Issue Type state
  ...
  const handleCreateAsset = () => {
    ...
    setEditingAsset({ 
      isNew: true, 
      status: 'IN_STOCK', // Default for new
  ...
  // --- ACTIONS: REPORT ISSUE (User & Admin) ---
  ...
  const handleReportIssue = async () => {
      if(!reportDesc) return alert("Please enter a description");
      ...
      if(res.success) {
          ...
          alert("Error reporting issue: " + res.error);
      }
  };
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] -m-8">
        ...
        <div className="p-4 border-b border-gray-200 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
            ...
            <div className="flex gap-2">
              ...
              {['ACTIVE', 'IN_STOCK', 'OUT_STOCK', 'RETIRED', 'MAINTENANCE'].map(status => (
                <button 
                  key={status}
                  ...
                  return (
                    <tr key={asset.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right text-sm font-medium">
                        <div className="flex justify-end gap-2">
                           {/* Report Issue: Visible to ALL */}
                           <button onClick={() => openReportModal(asset)} className="text-orange-500 hover:bg-orange-50 p-1.5 rounded" title="Report Issue">
            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
              <div>
                ...
                >
                  ...
                  <option value="OUT_STOCK">OUT_STOCK</option>
      ...
      {/* --- MODAL 4: REPORT ISSUE (For ALL Users) --- */}
      {reportingAsset && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded p-6 w-full max-w-md">
                  ...
                  <div className="flex justify-end gap-2">
                    <button onClick={() => setReportingAsset(null)} className="border px-4 py-2 rounded">Cancel</button>
                    <button onClick={handleReportIssue} className="bg-orange-600 text-white px-4 py-2 rounded">Submit</button>
                  </div>
              </div>
          </div>
      )}
